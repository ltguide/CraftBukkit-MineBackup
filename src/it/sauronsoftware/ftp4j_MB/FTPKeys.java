...
interface FTPKeys {
	 ...
	 */
	public String ACTIVE_DT_PORT_RANGE = "ftp4j_MB.activeDataTransfer.portRange";
	 ...
	 * form.
	 */
	public String ACTIVE_DT_HOST_ADDRESS = "ftp4j_MB.activeDataTransfer.hostAddress";
	 ...
	 */
	public String ACTIVE_DT_ACCEPT_TIMEOUT = "ftp4j_MB.activeDataTransfer.acceptTimeout";
	 ...
	 * after a PASV command. To avoid frequently reported NAT problems, ftp4j_MB
	 ...
	 * property, ftp4j_MB will change its behaviour and it will connect to the IP
	 * address returned from the server.
	 *
	 * @since 1.5
	 */
	public String PASSIVE_DT_USE_SUGGESTED_ADDRESS = "ftp4j_MB.passiveDataTransfer.useSuggestedAddress";
