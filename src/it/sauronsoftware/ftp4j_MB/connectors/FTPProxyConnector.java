 ...
 */
package it.sauronsoftware.ftp4j_MB.connectors;

import it.sauronsoftware.ftp4j_MB.FTPCommunicationChannel;
import it.sauronsoftware.ftp4j_MB.FTPConnector;
import it.sauronsoftware.ftp4j_MB.FTPIllegalReplyException;
import it.sauronsoftware.ftp4j_MB.FTPReply;
...
public class FTPProxyConnector extends FTPConnector {
	...
	public FTPProxyConnector(String proxyHost, int proxyPort) {
		this(proxyHost, proxyPort, "anonymous", "ftp4j_MB");
	}
