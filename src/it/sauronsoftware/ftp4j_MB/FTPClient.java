 ...
 */
package it.sauronsoftware.ftp4j_MB;

import it.sauronsoftware.ftp4j_MB.connectors.DirectConnector;
import it.sauronsoftware.ftp4j_MB.extrecognizers.DefaultTextualExtensionRecognizer;
import it.sauronsoftware.ftp4j_MB.extrecognizers.ParametricTextualExtensionRecognizer;
import it.sauronsoftware.ftp4j_MB.listparsers.*;
...
public class FTPClient {
	 ...
	 *
	 * Default one is a
	 * it.sauronsoftware.ftp4j_MB.connectors.direct.DirectConnector instance.
	 *
	 * @param connector
	 *            The connector used to connect the remote host.
	 * @see DirectConnector
	 ...
	 * ftp4j_MB gives you another FTPTextualExtensionRecognizer implementation,
	 ...
	 * objects registered on the client. The distribution of ftp4j_MB contains some
